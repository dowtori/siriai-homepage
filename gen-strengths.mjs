...
const PROMPTS = [
  ...
  { id:'S1', text:'Abstract sculptural genesis: a single smooth translucent liquid-glass droplet-orb floating in the void, with a luminous warm current swirling inside it, a soft inner glow, like a service taking form from a first problem. Perfectly smooth continuous curved glass surface, NO facets, NO sharp edges, no hard geometry. Warm amber (#FFC70D) and orange (#FF6B21) internal glow and rim-light. Serene, premium, the seed of something emerging.' },
  { id:'S2', text:'Abstract sculptural motion: a single sleek flowing ribbon of liquid glass, curving and streaking gracefully through the void as if caught mid-motion at high speed, soft warm light trailing along its length. Smooth aerodynamic continuous surface, dynamic yet elegant, velocity made form, rapid creation. Warm amber (#FFC70D) and orange (#FF6B21) glow. NO hard edges, no stacked plates, no facets.' },
  { id:'S3', text:'Abstract sculptural harmony: several smooth flowing strands of translucent liquid glass gracefully interweaving and braiding together into ONE single unified cohesive form, distinct threads becoming one whole. Smooth continuous curved surfaces, elegant and balanced. Warm amber (#FFC70D) with a soft pink (#E62E61) rim-light along the strands. Holistic, woven, a coherent unified system. NO concentric rings, no hard edges, no thin lines.' },
];
